	    	...
	    	<?php
	    		if ( ! dynamic_sidebar( 'homepage' ) ) {
	    			if ( 'true' == $settings['homepage_enable_product_categories'] && is_woocommerce_activated() ) {
	    				echo '<div class="homepage_product_categories_wrap">';
	    			...
	    			if ( 'true' == $settings['homepage_enable_featured_products'] && is_woocommerce_activated() ) {
	    				echo '<div class="homepage_featured_products_wrap">';
	    				echo '<div class="col-full">';
	    				the_widget( 'Woo_Featured_Products', array( 'title' => false, 'products_per_page' => intval( $settings['homepage_featured_products_limit'] ) ) );
	    				echo '</div></div>';
	    			}

	    			if ( 'true' == $settings['homepage_enable_recent_products'] && is_woocommerce_activated() ) {
	    				echo '<div class="homepage_recent_products_wrap">';
	    				echo '<div class="col-full">';
	    				the_widget( 'Woo_Recent_Products', array( 'title' => false, 'products_per_page' => intval( $settings['homepage_recent_products_limit'] ) ) );
	    				echo '</div></div>';
	    			}

	    			if ( 'true' == $settings['homepage_enable_testimonials'] ) {
	    				echo '<div class="homepage_testimonials_area_wrap">';
	    				echo '<div class="col-full">';
