...
{
	const TAG_OPEN = 'woocommerce_addons_tag_open';
	const TAG_CLOSE = 'woocommerce_addons_tag_close';
	const TAG_STANDALONE = 'woocommerce_addons_tag_standalone';
	const TAG_COMPLETE = 'woocommerce_addons_tag_complete';
	const TEXT = 'woocommerce_addons_text';
	...
	public function attach_fields()
	{
		...
		add_action( 'woocommerce_admin_field_'.self::TAG_OPEN, array( self::$object, 'form_tag_open' ), 10 );
		add_action( 'woocommerce_admin_field_'.self::TAG_CLOSE, array( self::$object, 'form_tag_close' ), 10 );
		add_action( 'woocommerce_admin_field_'.self::TAG_STANDALONE, array( self::$object, 'form_tag_standalone' ), 10 );
		add_action( 'woocommerce_admin_field_'.self::TAG_COMPLETE, array( self::$object, 'form_tag_complete' ), 10 );
		add_action( 'woocommerce_admin_field_'.self::TEXT, array( self::$object, 'form_text' ), 10 );
