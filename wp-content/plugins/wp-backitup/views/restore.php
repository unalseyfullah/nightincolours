...
<div class="wrap">
  ...
  <div id="content">
    ...
    <div class="widget">
      ...
      if (!$this->license_active())
      {
        printf( __('<p>* The automated restore feature is only available to licensed customers.  Please visit <a href="%s" target="_blank">%s</a> to get license WP BackItUp risk free for 30 days.</p>', 'wp-backitup'), WPBACKITUP__SITE_URL, WPBACKITUP__SITE_URL);
      }
      ?>
    </div>		
    ...
    if ($this->license_active())
    {
      ...
      <div class="widget">
        ...
        <p><b><?php _e('Upload WP BackItUp archive(zip) files to add to your list of available backups.', 'wp-backitup'); ?></b></p>
        <?php
        ...
        <div id="wpbackitup-plupload-modal" title="<?php _e('WP BackItUp - Upload backup files','wp-backitup'); ?>" style="width: 75%; margin: 16px; display:none; margin-left: 100px;">
          <p style="max-width: 610px;"><em><?php _e("Backup files may be uploaded into WP BackItUp with this form." ,'wp-backitup');?> <?php echo htmlspecialchars(__('They may also be uploaded manually into the WP BackItUp directory (wp-content/wpbackitup_backups) using FTP. When done uploading all backup files refresh this page.','wp-backitup'));?></em></p>
          <?php
          global $wp_version;
...
<?php } ?>
    ...
    <div id="status" class="widget">
      ...
      <ul class="restore-status">
        ...
        <li class="unzipping"><?php _e('Unzipping backup set', 'wp-backitup'); ?>...<span class='status-icon'><img class="unzipping-icon" src="<?php echo WPBACKITUP__PLUGIN_URL . "/images/loader.gif"; ?>" height="16" width="16" /></span><span class='status'><?php _e('Done', 'wp-backitup'); ?></span><span class='fail error'><?php _e('Failed', 'wp-backitup'); ?></span></li>
        <li class="validation"><?php _e('Validating backup file', 'wp-backitup'); ?>...<span class='status-icon'><img class="validation-icon" src="<?php echo WPBACKITUP__PLUGIN_URL . "/images/loader.gif"; ?>" height="16" width="16" /></span><span class='status'><?php _e('Done', 'wp-backitup'); ?></span><span class='fail error'><?php _e('Failed', 'wp-backitup'); ?></span></li>
...
<!--        <li class="activate_plugins">--><?php //_e('Activating plugins', 'wp-backitup'); ?><!--...<span class='status-icon'><img class="activate_plugins-icon" src="--><?php //echo WPBACKITUP__PLUGIN_URL . "/images/loader.gif"; ?><!--" height="16" width="16" /></span><span class='status'>--><?php //_e('Done', 'wp-backitup'); ?><!--</span><span class='fail error'>--><?php //_e('Failed', 'wp-backitup'); ?><!--</span></li>-->
      ...
      <div class="restore-errors">
        ...
        <span class='error223'><div class='isa_error'><?php _e('Error 223: An error occurred during the restore.  WP BackItUp attempted to restore the database to its previous state but were unsuccessful.  Please contact WP BackItUp customer support and do not attempt to perform any further restores', 'wp-backitup'); ?>.</div></span>
        ...
        <span class='error225'><div class='isa_error'><?php _e('Error 225: Restore option is only available to licensed WP BackItUp users', 'wp-backitup'); ?>.</div></span>
        ...
        <span class='error227'><div class='isa_error'><?php _e('Error 227: Restore cannot proceed because your backup was created using a different version of WP BackItUp.  Please contact WP BackItUp support to help convert this backup to the current version', 'wp-backitup'); ?>.</div></span>
        <span class="error230"><div class='isa_error'><?php _e('Error 230: WP BackItUp ran into unexpected errors during the database restore.  However, we were able to successfully revert the database back to its original state . This error may require importing the database manually', 'wp-backitup'); ?>.</div></span>
	    <span class="error235"><div class='isa_error'><?php _e('Error 235: WP BackItUp is not able to proceed because there is no zip utility available.  Please contact support', 'wp-backitup'); ?>.</div></span>
	    <span class="error250"><div class='isa_error'><?php _e('Error 250: WP BackItUp is unable to begin the restore because a backup is running.  Please wait for the backup to complete and then try again', 'wp-backitup'); ?>.</div></span>

        <span class="error251"><div class='isa_error'><?php _e('Error 251: WP BackItUp is unable to begin the restore because the backup manifest is empty', 'wp-backitup'); ?>.</div></span>
        ...
        <span class="warning300"><div class='isa_warning'><?php _e('Warning 300: Unable to restore all WordPress content. Please review your restore logs to see what WP BackItUp was unable to restore', 'wp-backitup'); ?>.</div></span>
        <span class="warning305"><div class='isa_warning'><?php _e('Warning 305: Unable to restore all plugins. Please review your restore logs to see what WP BackItUp was unable to restore', 'wp-backitup'); ?>.</div></span>
