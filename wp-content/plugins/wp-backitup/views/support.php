  ...
  <div id="content">
        ...
        <form action="<?php echo get_admin_url(),"admin-post.php"; ?>" method="post" id="<?php echo $namespace; ?>-support-form">
          ...
          <div class="widget">
            ...
            <p><?php printf(__('Please make sure to open a support ticket via WP BackItUp <a href="%s" target="_blank"> support portal.</a> before using this form.', 'wp-backitup'), esc_url('https://www.wpbackitup.com/support')); ?></p>
	        ...
	        <?php if (!$license_active && !$is_lite_registered) : ?>
		        <span style="color:red">* <?php _e('Please register your version of WP BackItUp for access to support.', 'wp-backitup') ?></span>
            <?php endif; ?>
