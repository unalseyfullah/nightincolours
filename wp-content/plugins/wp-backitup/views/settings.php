...
<!--             --><?php //endif; ?>
      ...
      <div class="widget">
        ...
        <p><?php _e('Many hosts limit the amount of space that you can take up on their servers. This option tells WP BackItUp the maximum number of backup archives that should remain on your hosts server.  Don\'t worry, we will always remove the oldest backup archives first.', 'wp-backitup') ?></p>
      ...
      <div class="widget">
        <h3 class="promo"><i class="fa fa-file-text-o"></i> <?php _e('Turn on logging?', 'wp-backitup') ?></h3>
        <p><b><?php _e('Turn on WP BackItUp logging.', 'wp-backitup'); ?></b></p>
     ...
     <div class="widget">
        ...
        <p><b><?php _e('Enter the batch size for each of your content items.', 'wp-backitup') ?></b></p>
  		<p><?php _e('These settings tell WP BackItUp how many items that should be added to the backup at a time.  If you experience timeouts while running a backup then these settings can be used to help reduce the amount of time it takes WP BackItUp to complete each backup task .', 'wp-backitup') ?></p>
      <p>
      ...
      <p>
        ...
        <p><?php _e('* These settings should only be modified by advanced users or when when working with WP BackItUp support.', 'wp-backitup') ?></p>
	     <?php
    ...
    <div class="widget dbfilters">
      ...
      <div class="widget">
        ...
        <label for="wpbackitup_delete_all"><?php _e('Check this box if you would like WP BackItUp to completely remove all of its data when the plugin is deleted.', 'wp-backitup') ?></label></p>
